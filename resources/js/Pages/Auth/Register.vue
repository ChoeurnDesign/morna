...
const registerWithGoogle = () => {
    // same redirect, backend handles create/login
...
<template>
    <AuthLayout title="Register">
        ...
        <p class="text-sm text-gray-600 mb-4">
            Join Morna Mulbeery with your email or continue with Google.
        </p>
        ...
        <div class="space-y-3 mb-6">
            ...
            >
                <span
                    class="inline-flex h-6 w-6 items-center justify-center rounded-full bg-white"
                >
                    <!-- same icon as login -->
                    <svg
