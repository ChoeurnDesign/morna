                ...
                <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="grid gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    v-model="form.name"
                                    required
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg text-base focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-colors"
                    ...
                    <div class="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
                        ...
                        <div class="flex flex-col sm:flex-row gap-6">
                            ...
                            <div class="sm:w-48">
                                <div
                                    class="aspect-[3/4] rounded-lg border-2 border-dashed border-gray-300 overflow-hidden bg-gray-50"
                                >
                                    <div
                                        v-if="imagePreview"
                            ...
                            <div class="flex-1">
                                ...
                                <!-- file inputs are ok; zoom mainly affects text inputs -->
                                <input
                                    type="file"
                                ...
                                <p class="mt-2 text-xs text-gray-500">
                                    Recommended: Square image, JPG or PNG, max
                                    2MB
                                </p>
                                <p
                    ...
                    <div class="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                ></textarea>
                                <p
                                    v-if="form.errors.ingredients_text"
                                    class="mt-1 text-sm text-red-600"
                                >
                            ...
                            <div>
                                <label class="flex items-center">
                                    ...
                                    >
                                        Product is active and visible to
                                        customers
                                    </span>
                                </label>
                            </div>
